...
public class start_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        my_vpage = (ViewPager) findViewById(R.id.my_view_pager);
        my_tab = (TabLayout) findViewById(R.id.my_tabs);

        setUpMyViewPager(my_vpage);
        my_tab.setupWithViewPager(my_vpage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_profile) {
            Intent i3=new Intent(start_activity.this,Profile.class);
            startActivity(i3);
            return true;
        }
    ...
    void setUpMyViewPager(ViewPager vp){
        ...
        vpa.addMyFragment(new Home(), "Home");
        vpa.addMyFragment(new MyNews(), "My News");
        vpa.addMyFragment(new Weather(), "Weather");
